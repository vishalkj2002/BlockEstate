...
contract LandRegistry {
    ...
    function addLand(
        ...
        propertiesControlledByRevenueDept[_revenueDepartmentId].push(
            propertyId
        );
    ...
    function getPropertiesByRevenueDeptId(
        ...
        uint256[] memory propertyIds = propertiesControlledByRevenueDept[
            _revenueDeptId
        ];
    ...
    function getRevenueDeptId(
        uint256 propertyId
    ) private view returns (uint256) {
        return
            propertiesContract
                .getLandDetailsAsStruct(propertyId)
                .revenueDepartmentId;
    }
